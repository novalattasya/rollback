...
Dataset adalah dasar dari pengetahuan AI.
...
3. Cek jawaban, bandingin dengan kalimat yang benar: `"enak"`
4. Hitung **loss** (seberapa jauh tebakan dari kebenaran)
5. Koreksi **parameter** (bobot) pakai **backpropagation**
...
Jadi yang di atas itu contoh codingan engineer buat ngelatih AI. Jadi ngelatih AI bukan kayak ngajarin anak kecil belajar membaca beneran, tapi memberi perintah pada model AI buat belajar sendiri dari dataset yang diberikan.
